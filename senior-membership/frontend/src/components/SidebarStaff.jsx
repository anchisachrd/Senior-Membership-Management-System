          ...
          <ul class="space-y-2 font-medium flex-grow">
            {userRole !== 'staff' ? (
              <div>
                ...
                <li>
                  ...
                  <ul id="dropdown-example" class="hidden py-3 space-y-2">
                    <li>
                      <Link to='/committee_candidateList' class="flex items-center p-2 ml-11 rounded-lg dark:text-gray-500 dark:hover:bg-gray-700 group">
              ...
              <div>
                ...
                <li>
                  <Link to='/staff_sendNotify' class="flex items-center p-3 rounded-lg dark:text-gray-500 dark:hover:bg-gray-700 group">
                ...
                <li>
                  <Link to='/staff_checkPayment' class="flex items-center p-3 rounded-lg dark:text-gray-500 dark:hover:bg-gray-700 group">
