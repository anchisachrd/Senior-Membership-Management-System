...
function ClubExpense() {
    ...
    const AddClubExpenseSchema = Yup.object().shape({
        ...
        note: Yup.string().when('expense_type', {
            ...
            then: (schema) => schema.required('กรุณากรอกหมายเหตุเมื่อเลือกค่าใช้จ่ายประเภทอื่น ๆ'),
    ...
    const handleAddClubExpense = async (values, { setErrors }) => {
        ...
        const data = {
          ...
          "note": values.expense_type === 'ค่าอื่นๆ' ? values.note : '',
        ...
        try {
          ...
          if (!response.ok) {
            ...
            throw new Error(errorData.message || "เกิดข้อผิดพลาดในการเพิ่มค่าใช้จ่ายทั่วไป");
          }
    ...
    return (
        <div class="ibm-plex-sans-thai-medium">
            <div class="p-12 sm:ml-64">
                <div class="text-xl text-black mx-3 mt-5 mb-8 font-bold">แจ้งชำระค่าใช้จ่ายทั่วไป</div>
                                ...
                                return (
                                    <Form>
                                        <div class="grid gap-6 md:grid-cols-2 mb-5">
                                            <div>
                                                <label htmlFor="proof_path" class="block mb-2 text-sm font-medium text-black">
                                                ...
                                                <Field
                                                    ...
                                                    name="proof_path"
                                                    id="proof_path"
                                                    class={`bg-light ${errors.proof_path && touched.proof_path ? "bg-red-100" : "border border-gray-400"} text-gray-900 text-sm rounded-lg w-full p-2.5`}
                                                />
                                                <ErrorMessage name="proof_path" component="div" class="text-red-600 text-xs mt-1" />
                                            </div>

                                            <div>
                                                <label htmlFor="expense_type" class="block mb-2 text-sm font-medium text-black">
                                                    ประเภทค่าใช้จ่าย
                                                </label>
                                                <Field
                                                    as='select'
                                                    name="expense_type"
                                                    id="expense_type"
                                                    class={`bg-light border border-gray-400 ${errors.expense_type && touched.expense_type
                                                ...
                                                <ErrorMessage name="expense_type" component="div" class="text-red-600 text-xs mt-1" />
                                            </div>
                                        </div>
                                        ...
                                        {values.expense_type === 'ค่าอื่นๆ' && (
                                            <div class="grid gap-6 md:grid-cols-1 mb-5">
                                                <div>
                                                    <label htmlFor="note" class="block mb-2 text-xs font-medium text-gray-600">
                                                        หมายเหตุ:
                                                    </label>
                                                    <Field
                                                        type="text"
                                        ...
                                        <div class="grid gap-6 md:grid-cols-2 mb-5">
                                            ...
                                            <div>
                                                <label htmlFor="amount" class="block mb-2 text-sm font-medium text-black">
                                                    จำนวนเงินที่โอน
                                                </label>
                                                <Field
                                                    type="text"
                                                    name="amount"
                                                    id="amount"
                                                    class={`bg-light ${errors.amount && touched.amount ? "bg-red-100" : "border border-gray-400"} text-gray-900 text-sm rounded-lg w-full p-2.5`}
                                                />
                                                <ErrorMessage name="amount" component="div" class="text-red-600 text-xs mt-1" />
                                            </div>

                                            <div>
                                                <label htmlFor="paid_at" class="block mb-2 text-sm font-medium text-black">
                                                ...
                                                <Field
                                                    ...
                                                    name="paid_at"
                                                    id="paid_at"
                                                    class={`bg-light ${errors.paid_at && touched.paid_at ? "bg-red-100" : "border border-gray-400"} text-gray-900 text-sm rounded-lg w-full p-2.5`}
                                                />
                                                <ErrorMessage name="paid_at" component="div" class="text-red-600 text-xs mt-1" />
                                            </div>
                                        </div>
